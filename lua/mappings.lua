...
-- C-h/j/k/l dihandle oleh smart-splits (navigasi nvim split + tmux pane seamless)

-- >> TAMBAHKAN BARIS INI UNTUK jk -> Esc <<
map("i", "jk", "<Esc>", { desc = "escape insert mode", noremap = true, silent = true})
